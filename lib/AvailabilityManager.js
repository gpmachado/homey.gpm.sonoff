...
class AvailabilityManagerBase {
  ...
  constructor(device, options = {}) {
    ...
    this.device = device;
    this.options = { checkInterval: 60 * 1000, logIdle: DEBUG_LEVEL >= 1, ...options };
   ...
   * @returns {Promise<boolean|null>} true se dispositivo respondeu, false se falhou,
   *   null se já há um poll em curso (não é evidência de nada - o chamador ignora)
   */
  async _pollDevice() {
